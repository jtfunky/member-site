...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'create') {
        ...
        $bonusDays = max(1, (int) ($_POST['bonus_days'] ?? 7));
...
<p class="field-hint">Entered on the normal sign-up page (register.php) for bonus trial days — separate from the raffle, which uses its own dedicated landing page.</p>
...
<details class="collapsible">
  ...
  <form method="POST" class="inline-form">
    ...
    <div class="form-row">
      ...
      <div class="form-group"><label>Bonus Days</label><input type="number" name="bonus_days" value="7" min="1"></div>
    </div>
    <div class="form-row">
